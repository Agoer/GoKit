...
@implementation UIImage (GoWaterMark)

- (UIImage *)imageWaterMarkWithImage:(UIImage *)image
                           imageRect:(CGRect)imgRect
                               alpha:(CGFloat)alpha {
  return [self imageWaterMarkWithString:nil
                                   rect:CGRectZero
                              attribute:nil
                                  image:image
                              imageRect:imgRect
...
- (UIImage *)imageWaterMarkWithString:(NSString *)str
  ...
  return [self imageWaterMarkWithString:str
                                   rect:strRect
                              attribute:attri
                                  image:nil
